...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  private ActivityAuthBinding(@NonNull RelativeLayout rootView, @NonNull Button login,
      @NonNull EditText loginTxt, @NonNull ImageView logo, @NonNull LinearLayout phoneNo) {
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.phoneNo;
      LinearLayout phoneNo = ViewBindings.findChildViewById(rootView, id);
      if (phoneNo == null) {
        break missingId;
      }

      return new ActivityAuthBinding((RelativeLayout) rootView, login, loginTxt, logo, phoneNo);
    }
