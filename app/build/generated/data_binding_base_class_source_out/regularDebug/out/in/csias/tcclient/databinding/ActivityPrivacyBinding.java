...
public final class ActivityPrivacyBinding implements ViewBinding {
  ...
  private ActivityPrivacyBinding(@NonNull ConstraintLayout rootView, @NonNull WebView webView) {
  ...
  public static ActivityPrivacyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPrivacyBinding((ConstraintLayout) rootView, webView);
    }
